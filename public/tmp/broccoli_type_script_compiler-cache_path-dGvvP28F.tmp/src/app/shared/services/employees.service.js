...
var EmployeesService = (function () {
     ...
     *
     */
    function EmployeesService(parseService) {
        this.parseService = parseService;
    }
    EmployeesService.prototype.query = function (policyId) {
        var url = 'classes/Employee?where={"policy":{"__type":"Pointer","className":"Policy","objectId":"' + policyId + '"}}';
        url = url + '';
