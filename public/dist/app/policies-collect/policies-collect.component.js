...
var PoliciesCollectComponent = (function () {
    ...
    PoliciesCollectComponent.prototype.submit = function () {
        ...
        this.cashAccountsService
            ...
            _this.feesService
                .put(_this.fee.objectId, { state: 1 /* PAGADO */ })
    ...
    PoliciesCollectComponent.prototype.getSelectedProducer = function (producerId) {
        return producerId ?
            this.producers.find(function (p) { return p.objectId === producerId; }) :
            null;
    };
